/*
 * File: app/store/tipo_identificacion/win014Store.js
 *
...
Ext.define('Legalhelp.store.tipo_identificacion.win014Store', {
    extend: 'Ext.data.Store',

    requires: [
        'Legalhelp.model.tipo_identificacion.tipoIdentificacionModel',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            ...
            autoSync: true,
            model: 'Legalhelp.model.tipo_identificacion.tipoIdentificacionModel',
            proxy: {
                type: 'ajax',
                api: {
