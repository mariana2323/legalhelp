/*
 * File: app/view/caso/Win039ViewController.js
 *
...
Ext.define('Legalhelp.view.caso.Win039ViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.caso.win039',

    editRecord: function() {
        var lista = Ext.getCmp('lstWin0391');
        var store = lista.getStore();
        var selection = lista._plugins[0].items[0]._record;
        Legalhelp.controller.Funciones.backWin(this, 'Legalhelp.view.caso.Win040', 'frmWin0401', selection);
    },

    onTxtWin0391Change: function(field, newValue, oldValue, eOpts) {
        var store = Ext.getCmp('lstWin0391').getStore();
        store.proxy.extraParams = {'filtro': newValue};
        store.load();
    },

    onBtnWin0391Tap: function(button, e, eOpts) {
        Legalhelp.controller.Funciones.backWin(this, 'Legalhelp.view.menu.Win028');
    },

    onBtnWin0392Tap: function(button, e, eOpts) {
        Legalhelp.controller.Funciones.logout(this);
    },

    onBtnWin00393Tap: function(button, e, eOpts) {
        Legalhelp.controller.Funciones.backWin(this, 'Legalhelp.view.menu.Win031');
    },

    onBtnWin0394Tap: function(button, e, eOpts) {
        Legalhelp.controller.Funciones.backWin(this, 'Legalhelp.view.menu.Win044');
    },

    onWin039Added: function(component, container, index, eOpts) {
